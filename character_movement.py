...
from kivy.graphics import Color, Rectangle, Line, Translate, PushMatrix, PopMatrix
            ...
            for c in range(FLOOR_SIZE):
                if (r, c) == self.pitch:
                    tile = Tile(
                        ...
                        on_stand=self.on_pitch_mode,
                        icon_source="./data/pitch_icon.png",
                    )
                elif (r, c) == self.rhythm:
                    tile = Tile(
                        size=tile_size,
                        pos=(c * tile_side_len, r * tile_side_len),
                        on_stand=self.on_rhythm_mode,
                        icon_source="./data/rhythm_icon.png",
                    )
                elif (r, c) == self.key:
                    tile = Tile(
                        size=tile_size,
                        pos=(c * tile_side_len, r * tile_side_len),
                        on_stand=self.on_key_mode,
                        icon_source="./data/key_icon.jpeg",
                    )
                else:
                    tile = Tile(
